...
'''
                                        ...
                                        for a in RESULT_TEMPLATE:
                                            # 获得配置中的
                                            for f in RESULT_TEMPLATE[a]:
                                                if f.startswith("n_", 0, len("n_")):
                                                    if location[0].isnumeric():
                                                        RESULT_TEMPLATE[a][f] = location[0]
                                                    else:
                                                        RESULT_TEMPLATE[a][f] = location[1]
                                                else:
                                                    if location[0].isnumeric():
                                                        RESULT_TEMPLATE[a][f] = location[1]
                                                    else:
